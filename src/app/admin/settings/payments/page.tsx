...
// Payment settings page (amounts and limits only)
// Stripe API keys are configured in /admin/settings/api
...
export default function PaymentSettingsPage() {
  ...
  return (
    <AdminLayout
      ...
      description="Configure payment amounts and limits"
    >
      ...
      <div className="mt-6 bg-blue-50 rounded-lg border border-blue-200 p-4">
        ...
        <p className="text-sm text-blue-800">
          To configure Stripe API keys (secret key, publishable key, webhook secret), go to{' '}
          <a href="/admin/settings/api" className="text-primary-600 hover:underline font-medium">
            Settings → API Keys
          </a>
        </p>
      </div>
